...
export function SimpleCTAWithImages() {
  return (
    <div className="mx-auto flex w-full max-w-7xl flex-col items-center justify-between px-4 py-20 md:flex-row md:px-8">
      ...
      <button className="group flex items-center space-x-2 rounded-lg bg-gradient-to-b from-emerald-500 to-emerald-700 px-4 py-2 text-base text-white shadow-[0px_2px_0px_0px_rgba(255,255,255,0.3)_inset]">
